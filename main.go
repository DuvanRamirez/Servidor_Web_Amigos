...
import (
	...
	"github.com/DuvanRamirez/go-web-server/controllers"
	"github.com/DuvanRamirez/go-web-server/handlers"
	"github.com/DuvanRamirez/go-web-server/models"
	repositorio "github.com/DuvanRamirez/go-web-server/repository" /* importando el paquete de repositorio */
...
func main() {
	...
	db, err := ConectarDB("postgres://dvjveoef:dcEa-_gI6pDN8Mq-ezAF9H0p6R38hiqp@suleiman.db.elephantsql.com/dvjveoef", "postgres")
	if err != nil {
